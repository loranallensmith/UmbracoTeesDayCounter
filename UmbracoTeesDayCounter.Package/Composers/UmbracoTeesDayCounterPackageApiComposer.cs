...
namespace UmbracoTeesDayCounter.Package.Composers
{
    public class UmbracoTeesDayCounterPackageApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Tees Day Counter Package Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoTeesDayCounterPackageOperationSecurityFilter>();
            });
        }

        public class UmbracoTeesDayCounterPackageOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("UmbracoTeesDayCounter.Package.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
